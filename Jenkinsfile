            ...
            steps {
                container('main') {
                    ...
                    withCredentials([nexusCredentials]) {
                        sh "mvn -pl rest -am -U -B -s .jenkins/settings.xml clean install -PITs -e ${talendOssRepositoryArg} -Dtest=ClientTestWithHttpbinTest#testBasicAuth -DfailIfNoTests=false"
                    }
                }
            }
            post {
