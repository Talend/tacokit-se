...
@PartitionMapper(name = "Subscriber", infinite = true)
@Documentation("TODO fill the documentation for this mapper")
public class SubscriberMapper implements Serializable {

    private final SubscriberMapperConfiguration configuration;

    private final PubSubService service;

    private final RecordBuilderFactory recordBuilderFactory;

    public SubscriberMapper(@Option("configuration") final SubscriberMapperConfiguration configuration,
            final PubSubService service, final RecordBuilderFactory recordBuilderFactory) {
    ...
    @Split
    public List<SubscriberMapper> split(@PartitionSize final long bundles) {
        ...
        // In this case bundles = 100 and we must try to return 10 SubscriberMapper with 1/10 of the overall work each.
        //
    ...
    @Emitter
    public SubscriberSource createWorker() {
        // here we create an actual worker,
        // you are free to rework the configuration etc but our default generated implementation
        // propagates the partition mapper entries.
        return new SubscriberSource(configuration, service, recordBuilderFactory);
    }
}
