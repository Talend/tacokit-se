...
@Processor(name = "Publisher")
@Documentation("TODO fill the documentation for this processor")
public class PublisherOutput implements Serializable {

    private final PublisherOutputConfiguration configuration;

    private final PubSubService service;

    public PublisherOutput(@Option("configuration") final PublisherOutputConfiguration configuration,
            final PubSubService service) {
    ...
    @ElementListener
    public void onNext(@Input final PublisherDefaultInput defaultInput) {
