...
public class CSVMessageGeneratorTest {
    ...
    public void generateTest() {
        ...
        Schema.Entry arrayEntry = rbf.newEntryBuilder().withName("array").withType(Schema.Type.ARRAY).withElementSchema(rbf.newSchemaBuilder(Schema.Type.STRING).build()).withNullable(true).build();
