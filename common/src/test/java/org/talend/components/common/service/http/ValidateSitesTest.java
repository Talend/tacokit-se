...
class ValidateSitesTest {
    ...
    @CsvSource(value = { //
            ...
            "http://239.255.255.255:80/my/api, false, true, true, true", //
            "http://www.google.fr, false, false, true, true",
            // HTTPS only
            "http://127.0.0.1/my/api, true, false, false, false",
            "https://127.0.0.1/my/api, true, false, false, true",
            "http://www.google.fr, false, false, false, false",
            "https://www.google.fr, false, false, true, true"})
    void valideSite(final String url, final boolean canAccessLocal, final boolean disableMulticast, final boolean allowNonSecure, final boolean expected) {
        final boolean validSite = ValidateSites.isValidSite(url, canAccessLocal, disableMulticast, allowNonSecure);
