...
[source,java]
----
include::./common-io/src/main/java/org/talend/components/common/stream/format/FormatConfiguration.java[]
----
...
- Define an implemantation of RecordReaderSupplier interface, that is a builder for RecordReader implementation, and register it to RecordReaderRepository (here, example for json).
[source,java]
----
static {
