...
public class SoqlQueryBuilderTest {
    ...
    public void testBuildSoqlQueryParentToChild() {
        ...
        String queryFromBuilder =
                new SoqlQueryBuilder(Arrays.asList("Name", "Contacts_records_LastName"), "Account").buildSoqlQuery();
    ...
    public void testBuildSoqlQueryComplexRelationship() {
        ...
        String queryFromBuilder = new SoqlQueryBuilder(Arrays
                .asList("Id", "Name", "OpportunityLineItems_records_Quantity", "OpportunityLineItems_records_ListPrice",
    ...
    public void testBuildSoqlQueryWithCustomTable() {
        ...
        String queryFromBuilder =
                new SoqlQueryBuilder(Arrays.asList("Id", "SLAExpirationDate__c"), "talend_custom__c").buildSoqlQuery();
    ...
    public void testBuildSoqlQueryWithCustomTablesChildToParent() {
        ...
        String queryFromBuilder = new SoqlQueryBuilder(Arrays
                .asList("talend_custom__c_Name", "talend_custom__c_custom_name__c", "talend_contact__r_Name",
                        "talend_contact__r_Account_Name"),
    ...
    public void testBuildSoqlQueryWithCustomTablesParentToChild() {
        ...
        String queryFromBuilder = new SoqlQueryBuilder(Arrays
                .asList("Name", "talend_custom__r_records_custom_lastName", "contact_title__c",
                        "talend_custom__r_records_custom_name__c",
    ...
    public void testBuildSoqlQueryWithComplexChildTableNameParentToChild() {
        ...
        String queryFromBuilder = new SoqlQueryBuilder(Arrays
                .asList("Name", "talend_contact__c_Persons_records_custom_lastName", "contact_title__c",
                        "talend_contact__c_Persons_records_talend_account__c_Age"),
                "talend_contact__c").buildSoqlQuery();
